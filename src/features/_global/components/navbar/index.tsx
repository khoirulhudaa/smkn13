            ...
            <div className="flex items-center gap-2 w-[40%] md:w-[30%]">
              <div className="leading-none flex gap-4 items-center">
                <div
                  ...
                  style={{ color: 'black' }}
                >
                  <img src={profile?.photoHeadmasterUrl} alt="Logo Sekolah" className="w-8 h-8 md:w-10 md:h-10 md:flex hidden object-contain" />
            ...
            >
              ...
              <div className="p-6 border-b border-white/10 flex items-center justify-between">
                <div className="flex items-center gap-3">
                   <img src={profile?.photoHeadmasterUrl} alt="Logo" className="w-8 h-8 rounded" />
