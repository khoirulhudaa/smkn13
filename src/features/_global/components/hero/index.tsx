...
export const HeroComp = ({titleProps, subTitle, id}: {titleProps?: string, subTitle?: string, id?: string}) => {
    ...
    >
      <div>
        ...
        >
          ...
          >
            {subTitle ? subTitle : profile?.heroSubTitle || "Menghadirkan standar pendidikan internasional dengan nilai-nilai luhur budaya bangsa."}
          </motion.p>
